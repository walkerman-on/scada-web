...
import { getLogin, getRegister } from 'app/providers/router/routeConfig/routes';
    ...
    <div className={cl.Form}>
      ...
      <section className={cl.auth}>
        <div className={cl.titleSection}>
          ...
          <AppLink to={getRegister()}>
            <span className={cl.text}>Регистрация</span>
          </AppLink>
        </div>
        <section className={cl.input}>
          <Input text="Логин" value={userData.login} onChange={onLoginHandle} size="large" />
          <Input text="Пароль" type="password" value={userData.password} onChange={onPasswordHandle} size="large" />
        </section>
        <AppLink to="/">
